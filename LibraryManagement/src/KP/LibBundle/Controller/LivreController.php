...
class LivreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $livres = $em->getRepository('KPLibBundle:Livre')->findAll();
    ...
    {
        $livre = new Livre();
        $form = $this->createForm('KP\LibBundle\Form\LivreType', $livre);
    ...
    {
        $deleteForm = $this->createDeleteForm($livre);
        $editForm = $this->createForm('KP\LibBundle\Form\LivreType', $livre);
