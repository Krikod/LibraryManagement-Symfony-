...
use KP\LibBundle\Entity\Auteur;
...
class AuteurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $auteurs = $em->getRepository('KPLibBundle:Auteur')->findAll();
    ...
    {
        $auteur = new Auteur();
        $form = $this->createForm('KP\LibBundle\Form\AuteurType', $auteur);
    ...
    {
        $deleteForm = $this->createDeleteForm($auteur);
        $editForm = $this->createForm('KP\LibBundle\Form\AuteurType', $auteur);
